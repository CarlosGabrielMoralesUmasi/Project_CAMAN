...
import 'champions_model.dart';
export 'champions_model.dart';

class ChampionsWidget extends StatefulWidget {
  const ChampionsWidget({Key? key}) : super(key: key);

  @override
  _ChampionsWidgetState createState() => _ChampionsWidgetState();
}

class _ChampionsWidgetState extends State<ChampionsWidget> {
  late ChampionsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChampionsModel());
  }
