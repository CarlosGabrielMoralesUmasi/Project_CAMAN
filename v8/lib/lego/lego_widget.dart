...
import 'lego_model.dart';
export 'lego_model.dart';

class LegoWidget extends StatefulWidget {
  const LegoWidget({Key? key}) : super(key: key);

  @override
  _LegoWidgetState createState() => _LegoWidgetState();
}

class _LegoWidgetState extends State<LegoWidget> {
  late LegoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LegoModel());
  }
