...
import 'coloso_model.dart';
export 'coloso_model.dart';

class ColosoWidget extends StatefulWidget {
  const ColosoWidget({Key? key}) : super(key: key);

  @override
  _ColosoWidgetState createState() => _ColosoWidgetState();
}

class _ColosoWidgetState extends State<ColosoWidget> {
  late ColosoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ColosoModel());
  }
