...
import 'home_canchas_model.dart';
export 'home_canchas_model.dart';

class HomeCanchasWidget extends StatefulWidget {
  const HomeCanchasWidget({Key? key}) : super(key: key);

  @override
  _HomeCanchasWidgetState createState() => _HomeCanchasWidgetState();
}

class _HomeCanchasWidgetState extends State<HomeCanchasWidget>
    with TickerProviderStateMixin {
  late HomeCanchasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeCanchasModel());
                          ...
                          children: [
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 0.0, 70.0, 0.0),
                              child: Text(
                                'Descubre las mejores canchas de futbol para tus pichangas',
