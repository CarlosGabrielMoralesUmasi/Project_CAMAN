...
import 'bombonera_model.dart';
export 'bombonera_model.dart';

class BomboneraWidget extends StatefulWidget {
  const BomboneraWidget({Key? key}) : super(key: key);

  @override
  _BomboneraWidgetState createState() => _BomboneraWidgetState();
}

class _BomboneraWidgetState extends State<BomboneraWidget> {
  late BomboneraModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BomboneraModel());
  }
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: CachedNetworkImage(
                            imageUrl:
                                'https://images.evisos.com.pe/2013/10/17/grass-sintetico-trujillo-rpm-980090572_ae90873b6_3.jpg',
